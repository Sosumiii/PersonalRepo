...
class PhysicsEngine:
    ...
    def __init__(self, physics_controller: PhysicsInterface, robot: "MyRobot"):
        ...
        driveBase = 0.585 #Meters   

        self.physics_controller = physics_controller
        
        driveGearBox = DCMotor.krakenX60(4)
        self.swerve = drivetrains.FourMotorDrivetrain()
        rotationGearBox = DCMotor.NEO(4)

        # Create a DCMotorSim for physics sim
        #gearbox = wpimath.system.plant.DCMotor()
